...
const SparkozTN10Page = () => {
  ...
  const productImages = [
    '/TN10sebotics.png',
    '/TN10-vorne.webp',
    '/TN10-batterie-aufladen.webp',
    '/TN10handbetrieb.webp'
  ];
  ...
  const characteristics = {
    ...
    aspiration: {
      ...
      image: '/modal2.webp',
      content: 'Moteur d\'aspiration puissant de 25 000 Pa avec système de filtration HEPA. Collecte efficace de tous types de débris et poussières fines.'
    },
    autonomie: {
      title: 'Autonomie exceptionnelle',
      image: '/modal3.webp',
      content: 'Batterie lithium haute capacité offrant jusqu\'à 8 heures d\'autonomie continue. Retour automatique à la station de charge et reprise du nettoyage.'
    },
    interface: {
      title: 'Interface tactile intuitive',
      image: '/modal4.webp',
      content: 'Écran tactile couleur 10 pouces pour programmation facile. Application mobile pour contrôle à distance et suivi en temps réel.'
    },
    maintenance: {
      ...
      <div className="bg-gray-50 border-b border-gray-200 py-3">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <nav className="flex items-center space-x-2 text-sm">
            ...
            <ChevronRight className="h-4 w-4 text-gray-400" />
            <span className="text-gray-900 font-medium">SPARKOZ TN10</span>
          </nav>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div className="w-full flex-1">
              <div className="h-[500px] bg-white overflow-hidden relative">
                <img
                  ...
                  alt="SPARKOZ TN10 - Interface cloud"
                  className="w-full h-full object-cover"
                />
              </div>
            </div>
          ...
          <div className="flex flex-col justify-between h-full" style={{ gap: '20px' }}>
            ...
            <div className="bg-gray-900 text-white px-6 py-5">
              <div className="text-3xl font-bold text-white mb-1 leading-[1.1] tracking-wide">12 500,00 €</div>
            ...
            <div className="bg-white px-6 py-5">
              ...
              <div className="space-y-2">
                <div className="flex items-center text-base text-gray-800 py-2 leading-[1.5] font-medium tracking-wide">
                  ...
                  4 fonctions : balayer, frotter, aspirer, essuyer
                </div>
                <div className="flex items-center text-base text-gray-800 py-2 leading-[1.5] font-medium tracking-wide">
                  <span className="w-2.5 h-2.5 bg-orange-500 rounded-full mr-3 flex-shrink-0"></span>
                  Navigation IA avec LiDAR + caméras 3D TOF
                </div>
                <div className="flex items-center text-base text-gray-800 py-2 leading-[1.5] font-medium tracking-wide">
                  <span className="w-2.5 h-2.5 bg-orange-500 rounded-full mr-3 flex-shrink-0"></span>
                  Efficacité jusqu'à 756 m²/h
                </div>
                <div className="flex items-center text-base text-gray-800 py-2 leading-[1.5] font-medium tracking-wide">
                  <span className="w-2.5 h-2.5 bg-orange-500 rounded-full mr-3 flex-shrink-0"></span>
                  Largeur de nettoyage : 35 cm
                </div>
                <div className="flex items-center text-base text-gray-800 py-2 leading-[1.5] font-medium tracking-wide">
                  <span className="w-2.5 h-2.5 bg-orange-500 rounded-full mr-3 flex-shrink-0"></span>
                  Autonomie 4-5 h (batterie 20 Ah)
                </div>
                <div className="flex items-center text-base text-gray-800 py-2 leading-[1.5] font-medium tracking-wide">
                  <span className="w-2.5 h-2.5 bg-orange-500 rounded-full mr-3 flex-shrink-0"></span>
                  Recharge automatique via borne intelligente
                </div>
                <div className="flex items-center text-base text-gray-800 py-2 leading-[1.5] font-medium tracking-wide">
                  <span className="w-2.5 h-2.5 bg-orange-500 rounded-full mr-3 flex-shrink-0"></span>
                  Mode manuel avec poignée télescopique
                </div>
                <div className="flex items-center text-base text-gray-800 py-2 leading-[1.5] font-medium tracking-wide">
                  <span className="w-2.5 h-2.5 bg-orange-500 rounded-full mr-3 flex-shrink-0"></span>
                  {'Niveau sonore < 65 dB'}
            ...
            <div className="bg-gray-900 text-white px-6 py-5">
              ...
              <div className="space-y-2 text-base">
                <div className="text-gray-100 leading-[1.5] font-medium tracking-wide">• SPARKOZ TN10 → SPZ-TN10-2025</div>
                <div className="text-gray-100 leading-[1.5] font-medium tracking-wide">• Station de charge automatique</div>
                <div className="text-gray-100 leading-[1.5] font-medium tracking-wide">• Système de navigation laser</div>
                <div className="text-gray-100 leading-[1.5] font-medium tracking-wide">• Kit de brosses professionnelles</div>
                <div className="text-gray-100 leading-[1.5] font-medium tracking-wide">• Filtres HEPA de rechange</div>
                <div className="text-gray-100 leading-[1.5] font-medium tracking-wide">• Application mobile SPARKOZ</div>
              </div>
            </div>
        ...
        <div className="mt-12 max-w-4xl">
          ...
          <div className="text-gray-700 leading-relaxed mb-6 text-base font-medium tracking-wide space-y-4">
            <p>
              Le Sparkoz TN10 Pro est un robot de nettoyage professionnel compact et puissant, conçu pour répondre aux besoins de propreté des environnements modernes : bureaux, commerces, établissements de santé, écoles, hôtels et autres espaces à fort passage.
            </p>
            <p>
              Grâce à sa navigation IA avancée, le TN10 Pro cartographie les espaces, planifie ses trajets en temps réel et évite les obstacles. Son système 4-en-1 combine balayage, aspiration, lavage et essuyage pour garantir des sols impeccables sur différents types de revêtements (carrelage, marbre, bois, vinyle, résine, etc.).
            </p>
            <p>
              Avec sa station de recharge automatique, il reprend le nettoyage dès que la batterie est rechargée, offrant un cycle continu sans intervention. Son mode manuel avec poignée télescopique assure une précision maximale dans les zones difficiles d'accès.
            </p>
            <p>
              Enfin, sa plateforme cloud permet de planifier, suivre et analyser vos opérations de nettoyage en temps réel pour une gestion simplifiée.
            </p>
          </div>
                  ...
                  <div className="space-y-6">
                    <div className="bg-white p-6 rounded-lg border">
                      <div className="space-y-4">
                        <div className="flex items-center text-base text-gray-800 py-2 leading-[1.5] font-medium tracking-wide">
                          <span className="w-2.5 h-2.5 bg-orange-500 rounded-full mr-3 flex-shrink-0"></span>
                          Nettoyage multifonction 4-en-1
                        </div>
                        <div className="flex items-center text-base text-gray-800 py-2 leading-[1.5] font-medium tracking-wide">
                          <span className="w-2.5 h-2.5 bg-orange-500 rounded-full mr-3 flex-shrink-0"></span>
                        ...
                        <div className="flex items-center text-base text-gray-800 py-2 leading-[1.5] font-medium tracking-wide">
                          <span className="w-2.5 h-2.5 bg-orange-500 rounded-full mr-3 flex-shrink-0"></span>
                          Contrôle manuel possible via poignée télescopique
                        </div>
                        <div className="flex items-center text-base text-gray-800 py-2 leading-[1.5] font-medium tracking-wide">
                          <span className="w-2.5 h-2.5 bg-orange-500 rounded-full mr-3 flex-shrink-0"></span>
                        ...
                        <div className="flex items-center text-base text-gray-800 py-2 leading-[1.5] font-medium tracking-wide">
                          <span className="w-2.5 h-2.5 bg-orange-500 rounded-full mr-3 flex-shrink-0"></span>
                          Application cloud pour gestion et rapports
                        </div>
                      </div>
                    </div>
                  </div>
                      ...
                      <div className="space-y-4">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                          <div>
                            ...
                            <div className="text-gray-700 ml-2">27 kg (sans eau)</div>
                          </div>
                          
                          <div>
                            <span className="font-semibold text-gray-800">Batterie :</span>
                            <div className="text-gray-700 ml-2">20 Ah</div>
                          </div>
                          
                          <div>
                            <span className="font-semibold text-gray-800">Réservoirs :</span>
                            <div className="text-gray-700 ml-2">10 L eau propre / 15 L eaux usées</div>
                          </div>
                          
                          <div>
                            <span className="font-semibold text-gray-800">Largeur de nettoyage :</span>
                            <div className="text-gray-700 ml-2">35 cm</div>
                          </div>
                          
                          <div>
                            <span className="font-semibold text-gray-800">Efficacité de nettoyage :</span>
                            <div className="text-gray-700 ml-2">756 m²/h</div>
                          </div>
                          
                          <div>
                            <span className="font-semibold text-gray-800">Niveau sonore :</span>
                            <div className="text-gray-700 ml-2">{'< 65 dB'}</div>
                          </div>
                          
                          <div>
                            <span className="font-semibold text-gray-800">Capteurs :</span>
                            <div className="text-gray-700 ml-2">LiDAR, caméra 3D TOF, capteurs avancés</div>
                          </div>
                        </div>
                        
                        <div className="mt-4 pt-4 border-t border-gray-200">
                          <span className="font-semibold text-gray-800">Autonomie (batterie 20 Ah) :</span>
                          <div className="ml-2 mt-2 space-y-1">
                            <div className="flex justify-between items-center bg-gray-50 p-2 rounded">
                              <span className="text-gray-700">Autonomie standard :</span>
                              <span className="font-medium text-green-600">4 à 5 h</span>
                            </div>
                          </div>
                        </div>
                      </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="bg-white p-4 rounded border">
                      ...
                      <p className="text-sm text-gray-700 mb-3">
                        Kit de brosses de rechange pour différents types de sols et applications spécifiques.
                      </p>
                    </div>
                    ...
                    <div className="bg-white p-4 rounded border">
                      ...
                      <p className="text-sm text-gray-700 mb-3">
                        Réservoirs supplémentaires pour étendre l'autonomie de nettoyage sans interruption.
                      </p>
                    </div>
                    
                    <div className="bg-white p-4 rounded border">
                      <h4 className="font-semibold text-gray-900 mb-2">Accessoires de lavage et essuyage</h4>
                      <p className="text-sm text-gray-700 mb-3">
                        Kit complet d'accessoires pour optimiser les fonctions de lavage et d'essuyage.
                      </p>
                    </div>
                    
                    <div className="bg-white p-4 rounded border">
                      <h4 className="font-semibold text-gray-900 mb-2">Modules logiciels de gestion avancée</h4>
                      <p className="text-sm text-gray-700 mb-3">
                        Modules logiciels avancés via cloud pour gestion complète et rapports détaillés.
                      </p>
                    </div>
                  </div>
                </div>
        ...
        >
          ...
          >
            ...
            <div className="flex justify-between items-start p-8 border-b border-gray-200">
              <div>
                <div className="text-sm text-gray-500 mb-1">SPARKOZ TN10</div>
...
export default SparkozTN10Page;